...
<div class="home-bg">
    <div class="container pt-5">
        <h1 class="text-center my-5 text-shadow">Instructor Dashboard</h1>
        <div class="row gap-4 mt-5 justify-content-center">
            <a href="{{route('instructor.courses.index')}}" class="col-auto shadow rounded pt-4 pb-2 px-5 mb-3 text-center text-decoration-none db-btn">
                <h3 class="font-semibold text-shadow">Your Courses</h3>
