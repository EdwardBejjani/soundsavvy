    ...
    <div class="container pt-5">
        ...
        <div class="mb-5 mt-3">
            <form action="{{route('instructor.courses.index')}}" method="GET" class="d-flex">
                ...
                <input type="text" class="form-control search-input ms-3" name="user_id" placeholder="Search by Instructor ID" value="{{request()->query('user_id') ?? ''}}">
            ...
            <table class="table table-bordered bg-dark">
                <thead>
                    <tr>
                        ...
                        <th class="bg-primary text-white">Instructor ID</th>
